...
# %% download data if needed and save the individual files at local folder
...
# %% concat data at local folder and save it as .parquet
...
# %%
# read data (remember to download it first with download_data() and concat_data())
...
# %% use the interface as you want
from interface.Interface import CollectionAtivos
from core.AtivosCore import Ativos

# create an instance of Collection ativos to use its methods
repo = CollectionAtivos()

# Remember: you have to setup Firebase prior to save/read it something from thre!

# pass a instance of Ativos to function `.save()`
# repo.save()

# pass an id:string to function `.read()` and get the db data for that id
# note: id is generated by Firebase
# repo.read('')
